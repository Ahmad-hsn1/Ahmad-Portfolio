            ...
            <div className="container flex items-center justify-between">
                <a className="text-xl font-bold text-primary flex items-center" href="#hero">
                    <span className="relative z-10">
                        <span className="text-glow text-foreground"> Ahmad's </span> Portfolio
                    </span>
                </a>
                ...
                <div className={cn("fixed inset-0 bg-background/30 backdrop-blur-lg z-40 flex flex-col items-center justify-center", 
