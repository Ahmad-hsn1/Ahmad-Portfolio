...
export const ContactSection = () => {
  ...
  emailjs
    .sendForm(
      "service_qv62gr7", // from EmailJS
      "template_w4xmtmd", // from EmailJS
      e.target,
      "OMqySv9AQJoEWIil1" // from EmailJS
    )
    .then(
      () => {
        toast({
    ...
    return (
        <section id="contact" className="py-24 px-4 relative bg-secondary/30">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
                <span className="text-glow">Get In</span> <span className="text-primary">Touch</span>
            </h2>
...
<a href="mailto:ahmadkhalid2q@gmail.com" className="text-muted-foreground hover:text-primary transitions-colors ">
ahmadkhalid2q@gmail.com` `
                                </a>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 className="font-medium px-19"> Phone</h4>
                                <a href="tel:+92 310-5395921" className="text-muted-foreground hover:text-primary transitions-colors ">
                                    +92 310-5395921
                                </a>
                            </div>
                        </div>
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                    ...
                    <form className="space-y-6 ">
                        <div>
                            ...
                            <input type="text" id="name" name="name" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="Ahmad Hsn..."/>
                        </div>
                        <div>
